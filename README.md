...
### 🤖 多模型支持
- Qwen-VL-Plus（推荐，性价比高）
- Qwen3-VL-Plus（最新版本）
- Qwen-VL-Max（最强视觉理解能力）
- **Qwen3-VL-32B-Instruct**（阿里云部署）⭐ 新增
- **Qwen3-VL-32B-Thinking**（阿里云部署，思维链模式）⭐ 新增
...
| **qwen3-vl-32b-instruct** ⭐ | 阿里云部署，32B参数 | 高质量视频分析 |
| **qwen3-vl-32b-thinking** ⭐ | 思维链推理模式 | 需要详细推理过程 |

### 视频大小限制

#### 上传模式
- 推荐: < 7MB
- API限制: base64编码后 < 10MB
- 自动压缩: 可将大视频压缩至符合限制
